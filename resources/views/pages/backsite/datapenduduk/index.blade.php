                                ...
                                @foreach($dataPenduduks as $dp)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('datapenduduk.show', $dp->id) }}" class="btn btn-primary detail-item"
                                           ...
                                           <a href="{{ route('datapenduduk.edit', $dp->id) }}" class="btn btn-success edit-item" data-toggle="modal"
