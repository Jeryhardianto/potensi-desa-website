...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Visi::create([
            'visi' => 'The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from de Finibus Bonorum et Malorum'
        ]);

        Misi::create([
            'misi' => 'The standard chunk of Lorem 1'
        ]);

        Misi::create([
            'misi' => 'The standard chunk of Lorem 2'
        ]);
